			...
			<c:forEach items="${page.result}" var="process">
				<tr>
					...
					<td class="td_list_2" align=left nowrap>
						...
						<a href="${ctx}/snaker/process/disable/${process.id }" class="btnDisable" title="禁用" onclick="return confirmDisable();">禁用</a>
						<a href="${ctx}/snaker/process/delete/${process.id }" class="btnDel" title="删除" onclick="return confirmDelAll();">删除</a>
						</shiro:hasPermission>
					</td>
				</tr>
			</c:forEach>
