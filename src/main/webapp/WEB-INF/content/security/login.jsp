		...
		<div id="login-content" class="clearfix">
			<form action="${ctx }/login" method="post">
				...
				<div >
					...
					<input type="radio" name="login_choice" id="admin" value="admin" style="width: auto" checked> 管理员
					</label>
					<label class="pull-left radio-inline">
					<input type="radio" name="login_choice" id="employee" value="emp" style="width: auto"> 员工
					</label>
				</div>
